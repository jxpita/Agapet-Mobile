                ...
                <View style={{ margin: '1%', height:width*0.2 }}>
                    <View style={{ flexDirection: "row", margin: '1%' }}>
                        ...
                        <View style={{ margin: '1%',width: '80%',height: deviceHeight *  0.13 }}>
                            <Text style={{ color: 'black', fontWeight: "bold", fontSize: width * 0.05, marginBottom: '1%' }}> {data.title}</Text>
                            <Text style={{ fontSize: width * 0.035, margin: '1%' }}>Fecha: {data.date}</Text>
                        </View>
            ...
            >
                <View style={{flex: 1, backgroundColor: '#000000AA', justifyContent: 'flex-end', height: '50%' }}>
                    ...
                    <View style={{
                        ...
                        {data.map((evento) => (this.renderContent(evento)))}
                    </View>
